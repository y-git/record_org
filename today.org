...
* 完成事项
** TODO summary 
*** DONE switch to my computer
CLOSED: [2017-01-09 Mon 15:41]
...
*** DONE fix tool->converter
CLOSED: [2017-01-11 Wed 12:00]
//fix tool->converter:
...
//rename XXXEngine to XXXComponentContainer


*** DONE fix skin animation
CLOSED: [2017-01-14 Sat 11:58]
refactor and test: save begin time
articulated also has the bug!?
//add assertion(updateFrame?)


//remove prepare

//refactor playonetime
...
//pass animation render test


//rename removeFromEngine to removeFromComponentContainer
//rename engine to container

//test removeFromEngine


//rename removeAllComponent to xxxs



//restore skin animation logic

//clean skin animation logic
...
//refactor skin animation unit test

//add skin render test
...
refactor: transform->setLocalToWorldMatrix
...
**** TODO rewrite bainian project(add more effect, show three cats)(use require:cmd/nodejs)
***** TODO fix in mobile
...
nodejs:
publish wdcb, wdfrp new version
