...
v0.6.1
** TODO improve 3d ui
*** TODO improve 3d text
**** TODO 3d bitmap font
refer to three-bmfont-text:
compute 3d bitmap bounding box,sphere
support multi page
support sdf

support light material



*** TODO line
support polygons line:
[[https://mattdesl.svbtle.com/drawing-lines-is-hard][Drawing Lines is Hard]]
...
** DONE use trello to manage roadmap
CLOSED: [2016-06-19 Sun 09:20]
https://trello.com/



** DONE improve 3d text
CLOSED: [2016-07-17 Sun 17:12]
*** DONE 3d bitmap font
CLOSED: [2016-07-17 Sun 10:46]
**** DONE support sdf
CLOSED: [2016-07-14 Wed 08:00]
//implement


**** DONE support light material
CLOSED: [2016-07-15 Fri 06:52]
//SdfBitmapFontMaterial extends StandardLightMaterial
//add light


//add BasicBitmapFontMaterial, BitmapFontMaterial
...
refactor:
//glsl: move to end
//add BitmapFontMaterial, BaiscBitmapFontMaterial
//rename SdfFontMaterial to SdfBitmapFontMaterial
//these Material should not has map glsl(not has sourceRegion,repeatRegion field!) 
//refactor EngineShaderLib->assert
//rename shaderlib->quadCmd to cmd





////***** TODO compute 3d bitmap bounding box,sphere

line,arrow also compute?

**** DONE support multi pages
CLOSED: [2016-07-17 Sun 10:46]
//implement

//unify basic,sdf,multi pages

//unit test

refactor:
//examples/asset/font folder, add bitmapFont/, ttfFont/ folder
//remove "_lib" postfix
//sceneTool add createCamera method
...
//refactor:
rename Line to SolidLine


** DONE add billboard
CLOSED: [2016-07-18 Mon 09:00]
//implement:
true
...
* TODO more
** TODO 3d text
*** TODO generate sdf 3d text file(png, fnt)

*** TODO optimize 3d text
...
** TODO Billboard
implement:
[[http://www.lighthouse3d.com/opengl/billboarding/index.php?billCheat2][cheat way]]

[[https://cesiumjs.org/2015/10/28/Billboard-Instancing/][Billboard Instancing]]
