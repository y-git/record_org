...
*** DONE edit basic material
CLOSED: [2017-06-28 Wed 14:04]



*** DONE add light material + ambient, direction light
CLOSED: [2017-07-08 Sat 11:35]
//draft
...
*** DONE fix
CLOSED: [2017-07-10 Mon 14:41]
////fix geometry,material:
////BasicMaterial,LightMaterial has own index,count(refer to light)
////remove MaterialData

//separate componentID from typeID

////move specifyMaterial method(setColor...) to SpecifyMaterialSystem
...
*** DONE unit test
CLOSED: [2017-07-11 Tue 12:38]
//pass current test

//pass light material test
test basic + light boxes
shaderLib_generator:
use utils only
...
////*** TODO fix
fix light,geometry
light,geometry use one buffer(LightData.buffer, Geometry.buffer)

////*** TODO unit test


*** DONE fix
CLOSED: [2017-07-11 Tue 17:14]
set init state:
enable cull face
...
fix:
//arraybuffer->bufferDataMap(vertex/normalBufferDataMap)
//set render worker->MainData.isTest:
test in render worker




////only when light change, send data



//pass basic_light run test


*** DONE refactor
CLOSED: [2017-07-14 Fri 17:26]
//Material be abstract class

//XXXMaterial->create: not pass materialClassName!

////extract EngineMaterial(SpecifyMaterial)
move logic from MaterialSystem to SpecifyMaterialSystem

//rename ThreeDTransformData->indexInArrayBuffer to index

//rename "canvasId" to "canvasID"

////check: not allow create light after init renderer


*** DONE point light
CLOSED: [2017-07-15 Sat 12:14]

*** DONE unit test
CLOSED: [2017-07-15 Sat 13:03]

*** DONE pass worker
CLOSED: [2017-07-15 Sat 15:23]
test type array count

*** DONE worker unit test
CLOSED: [2017-07-15 Sat 15:23]


** DONE optimize
CLOSED: [2017-07-16 Sun 10:54]
//optimize basic samples
...
** DONE add texture
CLOSED: [2017-07-21 Fri 15:52]
*** DONE basic material texture
CLOSED: [2017-07-17 Mon 13:59]

*** DONE unit test
CLOSED: [2017-07-18 Tue 10:49]




*** DONE refactor:
CLOSED: [2017-07-18 Tue 10:55]
rename verticeBuffers to vertexBuffers
...
fix programUtils->197

remove Shader.ts?


*** DONE pass worker
CLOSED: [2017-07-20 Thu 10:00]
source can send to worker?

*** DONE unit test
CLOSED: [2017-07-20 Thu 17:44]
unit test


*** DONE light material texture
CLOSED: [2017-07-21 Fri 15:24]




*** DONE pass worker
CLOSED: [2017-07-21 Fri 15:39]
//source can send to worker?
...
** DONE fix
CLOSED: [2017-07-21 Fri 18:55]
texture benchmark test:
//fix custom
//create and dispose: memory





** DONE publish alpha.4
CLOSED: [2017-07-22 Sat 10:46]
//update typescript to 2.4:
...
//fix frp->Stream import:
import MapStream, ... in Stream.ts???


////change global package to local!
...
last bind array buffer(consider normal buffer + vertex buffer)
