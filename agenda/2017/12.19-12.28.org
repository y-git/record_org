...
//test:
//test pool size 
//restore hardware test
** DONE learn test
CLOSED: [2017-12-19 Tue 20:04]

refactor:
//change to upper case

** DONE add benchmark test
CLOSED: [2017-12-28 Thu 21:54]
test time
...
//test no headless in ci



//install puppeteer in Wonder.js

////solve ci take too long time problem:
setViewport?



//write a tool to auto generate local data
...
//refactor: 
remove config->isGenerateDataFile
...
**** DONE rollup: generate index.re
CLOSED: [2017-12-26 Tue 18:27]
...
**** DONE benchmark test with jest + ci
CLOSED: [2017-12-28 Thu 12:14]


**** DONE nodejs tool for generate benchmark data
CLOSED: [2017-12-28 Thu 12:15]


////**** TODO can compare different version's benchmark data(use trend graph?)
refer to:
https://blogs.unity3d.com/cn/2013/12/30/monitoring-unity-performance-part-i/



*** DONE ci enhance
CLOSED: [2017-12-28 Thu 17:37]
////use stage
...
*** DONE refactor
CLOSED: [2017-12-28 Thu 17:49]
//rename render setting json file name(e.g. xxx_xxx render_setting, ...) to Xxx_xx, ...



////** TODO extract integrate test from unit test???
e.g. "fix bug" describe!
...
*** TODO use ci for deploy and pf(performance) test
write gulp task
