...
* 完成事项
** DONE optimize
CLOSED: [2017-12-01 Fri 11:09]
//finish bufferData optimize
...
refactor:
////rename geomemtry to geometry



*** DONE geometry add group
CLOSED: [2017-11-30 Thu 22:13]
////gameObject add group

////material add group

////render sort by group


////group is [0, 64]


same dataGroup use the same buffer!
same dataGroup use the same vertices,indices,...!




refactor:
rename dataGroup to group



optimize clone:
////set gameObject,material,geometry the same group
set geometry the same group

////clone(gameObject, [0,1,2,0])
clone(gameObject)
...
*** DONE add last send buffer opitimize
CLOSED: [2017-11-30 Thu 22:21]




*** DONE optimize memory
CLOSED: [2017-12-01 Fri 08:26]


*** DONE webgl1->v/pMatrix should has cache, while mMatrix should not has!
CLOSED: [2017-12-01 Fri 11:09]


////** TODO refactor 2.1.0 mapping 
refactor MainSystem:
...
* 编辑器计划
** TODO publish
remove public/, sass-cache/ folder!
