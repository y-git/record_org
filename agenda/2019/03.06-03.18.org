...
* 完成事项
** DONE prepare online editor zip for mickey
CLOSED: [2019-03-05 Tue 15:33]
create Wonder-Editor-Produce
...
*** TODO write document
**** DONE add draft
CLOSED: [2019-03-06 Wed 21:42]


**** DONE add img and add more content
CLOSED: [2019-03-07 Thu 16:20]



**** DONE add example->resources
CLOSED: [2019-03-07 Thu 16:20]
...
**** DONE check content
CLOSED: [2019-03-07 Thu 16:36]




*** DONE push to document
CLOSED: [2019-03-07 Thu 16:36]
...
*** DONE release 1.0 blog
CLOSED: [2019-03-07 Thu 17:58]
...
*** TODO check
////**** TODO suojin
**** DONE 我们要不要专门介绍了wonder的几个文件是什么，glb,wpk,wdb
CLOSED: [2019-03-07 Thu 20:01]


*** TODO update online docs


*** DONE editor
CLOSED: [2019-03-07 Thu 20:41]
**** DONE welcome,upgrade modal
CLOSED: [2019-03-07 Thu 20:41]
...
*** DONE fix chinese
CLOSED: [2019-03-08 Fri 08:24]


*** DONE docs add wpk explain
CLOSED: [2019-03-08 Fri 09:30]


*** DONE add more FAQ
CLOSED: [2019-03-08 Fri 09:45]



*** DONE finish website->first page
CLOSED: [2019-03-09 Sat 14:51]

1.函数式编程

使用Reason语言开发，提供高质量的产品
...
*** DONE forum
CLOSED: [2019-03-10 Sun 11:13]
//can't register and login???

**** TODO fix logo @mickey


**** DONE need authority
CLOSED: [2019-03-08 Fri 08:46]


**** DONE add more threads add posts(placement information for the newer)
CLOSED: [2019-03-10 Sun 11:13]
all:
resources
...
write benchmark report(compare with threejs)




** DONE merge pr
CLOSED: [2019-03-09 Sat 09:16]
...
//refactor App.re:
      ...
      {	            <Controller uiState dispatchFunc />
        uiState.isEditorAndEngineStart ?	          </div> :
          <Controller uiState dispatchFunc /> : ReasonReact.null	          <AppShell />


** DONE fix(geometry): 1.remove geometry component of all cubes;  the default cube geometry name will be changed!!!(sphere also) 
CLOSED: [2019-03-09 Sat 09:33]

should remove instead of dispose geometry
...
** DONE fix(copy): 1.pick gameObject; 2.keydown ctrl+d;    not work!!!
CLOSED: [2019-03-09 Sat 11:15]
...
** DONE fix(ui): the asset tree->folder shouldn't expand arrow if it has no children folder nodes but material nodes
CLOSED: [2019-03-09 Sat 11:47]



** DONE improve(ui): button add title
CLOSED: [2019-03-09 Sat 11:59]



** DONE test in macbook
CLOSED: [2019-03-08 Fri 10:04]





** DONE give wonder->tasks introduce doc for recruit
CLOSED: [2019-03-08 Fri 11:39]



** DONE increase wheel speed of no geometry imgui
CLOSED: [2019-03-10 Sun 16:22]

** DONE (fix) clone point light too bright(with ambient color)
CLOSED: [2019-03-10 Sun 17:08]



** DONE prepare github repo(wonder-editor, wonder.js)
CLOSED: [2019-03-10 Sun 20:14]
*** prepare for clone
...
** DONE create example(in windows)
CLOSED: [2019-03-09 Sat 18:26]



** DONE improve: increase wheel speed
CLOSED: [2019-03-09 Sat 19:53]

////** TODO fix(clone): 1.clone point light gameObject to exceed max limits; 2.undo
** DONE fix(clone): should limit clone gameObject which or its children has light component
CLOSED: [2019-03-10 Sun 07:51]




** DONE test in test env(@mickey)
CLOSED: [2019-03-10 Sun 17:08]


** DONE fix forum
CLOSED: [2019-03-11 Mon 07:07]



** DONE update tag
CLOSED: [2019-03-11 Mon 07:11]




** DONE write email to summary all accounts(in cmd)
CLOSED: [2019-03-11 Mon 07:29]
...
** DONE prepare accound to pronounce
CLOSED: [2019-03-11 Mon 07:02]
...
** DONE improve speed
CLOSED: [2019-03-10 Sun 10:15]


*** DONE website
CLOSED: [2019-03-09 Sat 09:39]
...
** DONE fix gesture: try prevent and stop when mousemove and drag->mousemove
CLOSED: [2019-03-08 Fri 09:55]
*** 360(10.0.0正式版)
https://jingyan.baidu.com/article/76a7e409dafd52fc3b6e15d4.html
...
** DONE mickey
CLOSED: [2019-03-10 Sun 10:15]
*** DONE push online editor
CLOSED: [2019-03-08 Fri 08:30]

*** DONE use http2
CLOSED: [2019-03-08 Fri 08:30]


*** DONE feat(docs): enable search
CLOSED: [2019-03-10 Sun 10:15]
...
** DONE replace showcase
CLOSED: [2019-03-12 Tue 08:28]


** DONE FAQ
CLOSED: [2019-03-12 Tue 08:26]
add compare
...
** DONE update online site
CLOSED: [2019-03-12 Tue 08:42]



** DONE edit Wonder.js->usage
CLOSED: [2019-03-12 Tue 08:55]
...
** DONE replace showcase
CLOSED: [2019-03-12 Tue 15:42]



** give more benchmark case



** DONE fix(export package): if import package p1 ;import package p2; export package.  the wpk size shouldn't contain p1!!!
CLOSED: [2019-03-13 Wed 06:47]
...
ssh登录：ssh root@47.99.200.210 
进入项目: cd wonder/wonder-website
git fetch and rebase
cd website/ 
yarn build
pm2 restart 0(这个0代表website，1代表wonder-server,3代表wonder-editor)
...
** DONE add more docs
CLOSED: [2019-03-13 Wed 10:35]



** DONE write qq announcement
CLOSED: [2019-03-13 Wed 10:35]
...
** DONE solve forum->link jump to bottom
CLOSED: [2019-03-13 Wed 20:59]



** DONE publish 1.0.1
CLOSED: [2019-03-14 Thu 08:13]
*** DONE merge "empty GameObject" @mickey
CLOSED: [2019-03-13 Wed 12:38]


*** DONE add "update pwa cache" @mickey
CLOSED: [2019-03-13 Wed 21:11]
...
** DONE write blogs
CLOSED: [2019-03-15 Fri 18:33]


*** DONE add to Wonder.js->How to build
CLOSED: [2019-03-15 Fri 14:36]


*** DONE write resource blog
CLOSED: [2019-03-15 Fri 18:32]
...
** DONE create weixin gongzhouhao
CLOSED: [2019-03-16 Sat 13:14]


** DONE fix blog
CLOSED: [2019-03-16 Sat 10:55]



** DONE write editor->language
CLOSED: [2019-03-16 Sat 21:35]


add controller->transform gizmo->title


** DONE update doc
CLOSED: [2019-03-16 Sat 18:54]





** DONE fix Wonder.js, Wonder-Editor->package.json: move jest to dev
CLOSED: [2019-03-16 Sat 20:56]



** DONE publish engine -> 1.0.2
CLOSED: [2019-03-16 Sat 20:52]

write release


** DONE publish editor-> 1.0.2
CLOSED: [2019-03-16 Sat 21:35]

//update wonder.js to 1.0.2


////** TODO feat(doc): support language



** DONE create Wonder-CD project in gitlab
CLOSED: [2019-03-19 Tue 07:47]


*** DONE write gulp for push to online 
CLOSED: [2019-03-19 Tue 07:12]



*** DONE write gulp for push to pre-publish(editor)
CLOSED: [2019-03-19 Tue 07:12]



*** DONE write gulp for push to test environment
CLOSED: [2019-03-19 Tue 07:12]
...
*** DONE write gulp for push website to online environment
CLOSED: [2019-03-19 Tue 07:47]
...
** DONE refactor:     
CLOSED: [2019-03-18 Mon 20:25]
MainEditor: isEngineStart: uiState.isEditorAndEngineStart,

Index.re: need create editorState explicitly?


** DONE make a fly demo
CLOSED: [2019-03-19 Tue 15:13]
...
** TODO mickey
*** DONE feat(scene-tree): add icon
CLOSED: [2019-03-13 Wed 14:15]

*** DONE add blog to website
CLOSED: [2019-03-13 Wed 14:15]


*** DONE make a detail tutorial
CLOSED: [2019-03-13 Wed 22:36]


*** DONE @Mickey(杨浩Mickey) add pre-publish environment
CLOSED: [2019-03-14 Thu 11:47]

*** DONE @Mickey(杨浩Mickey) fix pwa: should test in pre-publish environment
CLOSED: [2019-03-14 Thu 11:47]
...
*** TODO update website->blog->date




*** TODO pronounce in zhihu,bokeyuan,... (in china)
