...
//buffer data->set map, get map(not support remove map):

mapManager



setting define max texture count
...
***** DONE refactor
CLOSED: [2018-05-10 Thu 15:33]
////chage xxxXXX to xxx_xxx:
e.g. xxx_noInstance


//remove defaultXxx in state(e.g. basicMaterialRecord, ...)



//rename TypeArrayService-> UIntx_xx to Uintxxx


***** DONE add more
CLOSED: [2018-05-10 Thu 16:21]

detect gl->max texture count, check >= setting define max texture count


***** DONE optimize
CLOSED: [2018-05-10 Thu 17:16]
...
***** DONE dispose texture
CLOSED: [2018-05-10 Thu 18:47]

//dispose geometry:
texCoords
vbo buffer
reallocate custom geometry




dispose basicMaterial->map
...
////create and dispose: share the same map
...
***** DONE fix
CLOSED: [2018-05-10 Thu 21:02]
//custom geometry->infos use Uint32



***** DONE feat
CLOSED: [2018-05-11 Fri 11:49]

//fix init gameObject->texture: if no texture, not init


//perf: custom geometry->info: count not equal geometry point count


//texture:
remove widths, heights
remove setWidth, setHeight

add filter, wrap data
...
***** DONE worker
CLOSED: [2018-05-12 Sat 16:56]
****** DONE draft
CLOSED: [2018-05-11 Fri 18:36]
create buffer data:
//basic material
...
get sourceMap in render worker



init texture when render:
when init gameObject
...
add cases:
//fix _createImageBitmap stream problem!


//init texture


//init texture for render




bind, update, send texture when render basic 
...
***** DONE refactor
CLOSED: [2018-05-12 Sat 17:11]
rename setting->databuffercount to count?
**** DONE support hot load texture
CLOSED: [2018-05-12 Sat 21:01]
change map
...
**** DONE test
CLOSED: [2018-05-12 Sat 21:22]

//refer to hotLoad test
...
**** DONE refactor
CLOSED: [2018-05-13 Sun 08:47]
rename setting->memory->xxxXXX to xxx_xxx


**** DONE optimize
CLOSED: [2018-05-13 Sun 08:59]
if lastMaterial are the same, not bind,update texture
...
//add format, type type arrays



add AssetDatabase system
...
**** DONE instance
CLOSED: [2018-05-14 Mon 10:18]

////**** TODO worker

**** DONE test
CLOSED: [2018-05-14 Mon 10:19]


**** DONE handle clone
CLOSED: [2018-05-14 Mon 11:02]


**** DONE fix clone bug
CLOSED: [2018-05-14 Mon 12:25]


**** DONE handle redo-undo
CLOSED: [2018-05-14 Mon 20:14]
...
**** DONE fix
CLOSED: [2018-05-15 Tue 10:00]
1.batch: error!


2.instance: basic should has map!!!

**** DONE finish TODOs
CLOSED: [2018-05-15 Tue 11:31]

//reduce default textureCount to 64
...
*** DONE diffuse, specular texture
CLOSED: [2018-05-16 Wed 21:05]


**** DONE basic logic
CLOSED: [2018-05-16 Wed 05:19]
...
//refactor shaders.json->noXxxXxx to no_xxx_xxx
...
CLOSED: [2018-05-17 Thu 07:01]



*** DONE e2e test
CLOSED: [2018-05-21 Mon 18:11]
...
rename texture to basicSourceTexture
add arrayBufferViewSourceTexture
...
add arrayBufferViewSourceTexture test cases:
    no worker


//basicSource->record->offset
...
render->bind, update:
//fix bug: set gl texture before(judge texture index)
...
//refactor initMaterialRenderWorker_test.re
...
//create and dispose
  ...
  finish!
  updateUint8ArraySource
  updateHTMLImageElementSource

worker:
send uint8Array source map to worker
...
refactor:
//e2e test->tool->map: accept texture, not source!

//duplicate

//move "%identity" to Type.re
...
test in worker:
can postMessage send uint8array data?
yes
...
refactor:
remove duplicate in arrayBufferViewSourceTexture
...
//support run render report->html:
add window.loadImage function: use fetch?
...
improve fetch(use node->fetch library?)





update Wonder-Benchmark->puppeteer version

update wonder-benchmark version


add dependences: get-pixels



wonder.js remove dev-dependences: get-pixels


upgrade     "puppeteer": "^0.13.0"
...
add e2e->pf json to e2e->render,data/


*** DONE code climate
CLOSED: [2018-05-21 Mon 20:50]



*** DONE test coverage
CLOSED: [2018-05-21 Mon 20:53]
...
*** DONE update data/ json
CLOSED: [2018-05-21 Mon 20:56]
...
*** TODO transform support rotate, scale
