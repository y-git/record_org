...
** DONE fix all engine bug issue
CLOSED: [2018-05-03 Thu 20:22]


** DONE update editor->engine version
CLOSED: [2018-05-03 Thu 20:22]

pass compile and test:
...
optimize:
customGeometry->setDefaultTypeArrData$6
...
//fix package.json->e2e:xxx



refactor:
rename setFirstBoxTobeCurrentGameObject to setFirstBoxToBeCurrentGameObject
