...
* 完成事项
** DONE life
CLOSED: [2018-01-27 Sat 15:30]
foot

bash

** TODO add light
*** DONE light material not share index with basic material
CLOSED: [2018-01-28 Sun 11:46]
gameObject add basicMaterialMap, lightMaterialMap(add addBasicMaterialComponent, addLightMaterialComponent)



*** DONE add light material component
CLOSED: [2018-01-28 Sun 17:58]

pass unit test



*** DONE init material(shader, glsl)
CLOSED: [2018-01-30 Tue 15:04]
...
////add afterRender pipelines:

////add job after render job in render_pipeline: 
clean light dirty
add "TODO: unit test!"
...
*** DONE draw ambient light
CLOSED: [2018-01-31 Wed 19:15]
////add sub job?:
get_basic_material_gameObjects?
get_light_material_gameObjects?




//add front render light job
...
////test->last: bind index buffer

//fix with RenderBasicJob



//add clear lastSend job


//refactor:
    //remove:
lastSendArrayBuffer: option(buffer),
lastSendElementArrayBuffer: option(buffer),
...
*** DONE refactor
CLOSED: [2018-02-01 Thu 10:05]
//refactor duplicate:
render job
init, render job tests
...
////rename json config:
eliminate xxxXXX to be xxx_xxx
...
//remove isColorDirtys


*** DONE pass test
CLOSED: [2018-02-01 Thu 22:48]
pass unit test:
light material

//ambient light:
test:
disposed light shouldn't be send uniform data
...
*** DONE refactor
CLOSED: [2018-02-02 Fri 08:58]
pass all TODO



*** DONE pass direction light
CLOSED: [2018-02-02 Fri 21:16]
...
#define DIRECTION_LIGHTS_COUNT 1 should in top

add attribute/uniform to varDeclare instead of top?
...
*** DONE benchmark
CLOSED: [2018-02-03 Sat 09:37]


bottle in gpu->light glsl


*** DONE refactor
CLOSED: [2018-02-03 Sat 10:35]
//duplicate with ambient

//rename "getJob" to "execJob"


////move jobData, shaderLibData to configJsonData?



*** DONE pass point light
CLOSED: [2018-02-04 Sun 17:17]
//add component
...
*** DONE pass test
CLOSED: [2018-02-04 Sun 19:22]
unit test



*** DONE pass benchmark
CLOSED: [2018-02-04 Sun 20:30]

pass current pf test
...
*** DONE refactor
CLOSED: [2018-02-05 Mon 12:05]
//remove "ignore" in ecs, other?
(use ...state as many as possible)

(should not affect performance!)


component data not be mutable?


component data not option?
...
refactor: 
//return disposedIndexArray: let (index, newIndex) = generateIndex(index, disposedIndexArray);



////component admin can open Common files:
restore, deepCopyxxx, getXXXData can not in System



//rename XXXUniformXXXNoCacheXXX to XXXNoCachableXXX
//rename XXXUniformXXXCacheXXX to XXXCachableXXX
...
*** TODO support normal matrix instance
**** DONE fix normal matrix
CLOSED: [2018-02-05 Mon 15:31]
//fix
...
**** DONE add normal matrix instance data
CLOSED: [2018-02-06 Tue 09:14]
//implement
...
** DONE finish remain
CLOSED: [2018-02-07 Wed 07:23]
//add benchmark basic report
