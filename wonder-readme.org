...
#+BEGIN_SRC html
  <script src="dist/wd.all.min.js"></script>
#+END_SRC
...
- debug
  ...
  You can first include wd.all.innerLib.js file, then include wd.all.debug.js file in your html, then you can debug in engine ts
  file:

#+BEGIN_SRC html
  <script src="dist/wd.all.innerLib.js"></script>
  <script src="dist/wd.all.debug.js"></script>
#+END_SRC
* License
MIT Licence
